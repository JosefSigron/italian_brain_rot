...
echo ===================================================
call python "%~dp0generate_text.py"
...
echo ===================================================
call python "%~dp0generate_image.py"
echo Exit code: %ERRORLEVEL%
if %ERRORLEVEL% neq 0 (
...
echo ===================================================
call python "%~dp0generate_speech.py"
echo Exit code: %ERRORLEVEL%
if %ERRORLEVEL% neq 0 (
...
echo ===================================================
call python "%~dp0create_video.py"
echo Exit code: %ERRORLEVEL%
if %ERRORLEVEL% neq 0 (
...
if /i "%upload_choice%"=="Y" (
    ...
    echo ===================================================
    call python "%~dp0upload_to_youtube.py"
    echo Exit code: %ERRORLEVEL%
    if %ERRORLEVEL% neq 0 (
